...
class NetworkBackend extends Backend<GdkBackendEvent> {
  ...
  Future<Result<Map<String, GdkAssetInformation>?>> _refreshAssets(
      GdkAssetsParameters params) async {
  ...
  Future<Result<void>> _setTransactionMemo(Tuple2<String, String> tuple) {
    return session.setTransactionMemo(tuple.item1, tuple.item2);
  }
