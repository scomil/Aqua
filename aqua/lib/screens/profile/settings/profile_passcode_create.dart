...
class ProfilePasscodeCreate extends StatelessWidget {
  static const routeName = '/profilePasscodeCreate';

  const ProfilePasscodeCreate({Key? key}) : super(key: key);
          ...
          onChange: (context, arguments) {
            if (arguments != null) {
              Navigator.of(context).pushNamedAndRemoveUntil(
                ProfilePasscodeCreate.routeName,
                (route) =>
                    route is! RawDialogRoute &&
                    route.settings.name != ProfilePasscodeCreate.routeName,
                arguments: arguments,
              );
            }
          },
