...
import 'package:aqua/common/widgets/aqua_outlined_button.dart';
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        ...
        ProviderListener<Object?>(
          provider: profileSettingsShowPasscodeEnableProvider,
          onChange: (context, object) {
            if (object != null) {
              Navigator.of(context).pushNamed(ProfilePasscodeEnable.routeName);
            }
          },
          child: Container(),
        ),
        ProviderListener<Object?>(
          provider: profileSettingsShowPasscodeLockProvider,
                      ...
                      children: [
                        ...
                        MenuItemWidget(
                          ...
                          trailing: Consumer(builder: (context, watch, _) {
                            final value = watch(
                                profileSettingsSwitchPasscodeValueProvider);
                            return value != null
                                ? Switch(
                                    onChanged: (_) {
                                      context
